...
const Section = ({ title, data }: { title: string, children?: React.ReactNode, data: Webconfig }) => {
    const [tab, setTab] = React.useState<'all' | 'text' | 'textarea' | 'image' | 'file'>('all');
    const { image, text, textarea } = data ?? { image: [], text: [], textarea: [] }
    // all data
    ...
    return (
        ...
        >
            ...
            >
                <h1
                    className='text-[1.5rem] font-semibold text-primaryAdmin font-poppins'
                >
                    {title} Section
                </h1>
                <div>
                            ...
                            return (
                                <button
                                    ...
                                    px-[1rem] py-[0.5rem] rounded-md uppercase
                                     ${tab === type ? 'bg-primaryAdmin text-white' : 'bg-slate-100 text-primaryAdmin'}`}
                                    key={type}
                                    onClick={() => setTab(type)}
                                >
                                    {type}
...
const TextCard = (webconfig: WebconfigData) => {
    ...
    return (<>
        ...
        >
            ...
            >
                <img src="https://www.svgrepo.com/show/511906/edit-1483.svg"
        ...
        >
            ...
            >
                ...
                >
                    <h1
                        className='font-poppins text-[1.5rem] text-primaryAdmin font-semibold'
                    >
