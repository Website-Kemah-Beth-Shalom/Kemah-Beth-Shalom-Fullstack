...
export default function GalleryPage({ images }: { images: GalleryPageProps }) {
    ...
    return (
        <>
            ...
            <AdminLayout>
                <div className="flex flex-col gap-2 p-boxS bg-[#f0f3f5] max-w-screen overflow-x-hidden">
                    <div className="flex flex-col justify-between items-center p-boxS bg-[#f0f3f5] w-full">
                        {/* search button */}
                    ...
                    <div className="flex flex-row gap-2 w-full overflow-x-hidden overflow-y-hidden">
                        <div className="bg-white rounded-xl p-boxS flex flex-col gap-2 shadow-md cursor-pointer w-[15rem] h-fit">
                            <button
                        ...
                        <div className="flex flex-row gap-2 flex-wrap w-full overflow-x-hidden overflow-y-hidden">
                            {images?.data?.map((item: ImageProps) => {
                                return <GalleryModal {...item} />;
                            })}
                            {/* Pagination */}
...
const GalleryModal = (props: any) => {
    ...
    return (
        <>
            ...
            {/* Modal */}
            <ModalOverlay onClose={() => setShowModal(false)} show={showModal}>
                <section
                ...
                >
                    ...
                    >
                        <h1 className="capitalize text-primaryBlack font-semibold font-poppins">
                            {props.title}
                        </h1>
                    ...
                    <button className="bg-primary text-white p-boxS rounded-lg w-full">
                        Save
                    </button>
                    <button
                        onClick={() => {
